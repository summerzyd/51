...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST', '192.168.1.222'),
            'port'      => env('DB_PORT', 3306),
            'database'  => env('DB_DATABASE', 'dsp1224'),
            'username'  => env('DB_USERNAME', 'root'),
            'password'  => env('DB_PASSWORD', 'biddingos'),
            'charset'   => 'utf8',
    ...
    */
    ...
    'redis' => [
        ...
        'pika_target' => [
            'host'     => env('PIKA_TARGET_HOST', '127.0.0.1'),
            'port'     => env('PIKA_TARGET_PORT', 6379),
            'database' => env('PIKA_TARGET_DATABASE', 0),
            'password' => env('PIKA_TARGET_PASSWORD', null),
        ],

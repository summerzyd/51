...
return [
    ...
    */
    ...
    'manualCPACampaignAffiliate' => ['A2A', 'A2D-AF', 'A2C-AF'],
    'preData' => [
        'A2A' => ['广告主（全称）', '广告名称', '媒体商（全称）', '日期', 'CPA量', '广告主消耗', '媒体支出'],
        'A-AD' => ['广告主（全称）', '广告名称', '日期', 'CPA量', '广告主消耗'],
        'A2D-AF' => ['广告主（全称）', '广告名称', '媒体商（全称）', '日期', '下载量', '媒体支出'],
        'A2C-AF' => ['广告主（全称）', '广告名称', '媒体商（全称）', '日期', '点击量', '媒体支出'],
        'C2C' => ['广告主（全称）', '广告名称', '媒体商（全称）', '日期', '点击量', '广告主消耗', '媒体支出'],
        'D2D' => ['广告主（全称）', '广告名称', '媒体商（全称）', '日期', '下载量', '广告主消耗', '媒体支出'],
        'T2T' => ['广告主（全称）', '广告名称', '媒体商（全称）', '日期', '广告主消耗', '媒体支出'],
    ],
    'manualD2D' => 'D2D',
    'manualC2C' => 'C2C',
